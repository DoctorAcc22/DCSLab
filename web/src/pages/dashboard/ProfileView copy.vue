...
//#region onMounted
onMounted(async () => {    
  // const hasRolePOSOwner = userContext.value.roles.some(role => role.display_name === 'POS-owner');
  // const hasRoleWHOwner = false; 
  
  // roles.value.forEach((role, index) => { 
  //   if(role.value === 'pos') {
  //     var result =  hasRolePOSOwner.value;
  //     roles.value[index].active = result;
  //   } else {
  //     roles.value[index].active = hasRoleWHOwner;
  //   }      
  // });
  console.log('start');
  setRoles;
...
const setRoles = computed(() => {
  console.log('computed');
    roles.value.forEach((result, index) => {
      console.log('foreach roles');
      if(result.value == 'pos') {
        console.log('pos');
        userContext.value.roles.forEach((role) => {
          if(role.display_name == 'POS-owner') {
            console.log('pos = true')
            roles.value[index].active = true;
          }          
        });        
      } else {
        roles.value[index].active = false;
      }
    });
});
//#endregion
