...
import { FormInput, FormInputCode, FormLabel, FormTextarea, FormSelect } from "../../base-components/Form";
...
<template>
  <div class="mt-8">
    <LoadingOverlay :visible="loading">
      ...
      <div v-else>
        <VeeForm id="warehouseForm" v-slot="{ errors, handleReset }" @submit="onSubmit">
          <AlertPlaceholder :errors="errors" />
          <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
            <template #card-items-0>
              <div class="p-5">
                <VeeField v-slot="{ field }" v-model="userLocation.company.id" name="company_id">                  
                  <FormInput id="company_id" name="company_id" type="hidden" v-bind="field" />
                </VeeField>
                <VeeField v-slot="{ field }" v-model="userLocation.branch.id" name="branch_id">                  
                  <FormInput id="branch_id" name="branch_id" type="hidden" v-bind="field" />
                </VeeField>                
                <div class="pb-4"> 
                  <FormLabel html-for="code" :class="{ 'text-danger': errors['code'] }">
                    {{ t('views.warehouse.fields.code') }}
                  </FormLabel>
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.code" name="code" rules="required|alpha_dash"
                ...
                <div class="pb-4">
                  ...
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.name" name="name" rules="required"
                    :label="t('views.warehouse.fields.name')">
                    <FormInput id="name" v-bind="field" name="name" type="text" :class="{ 'border-danger': errors['name'] }"
                ...
                <div class="pb-4">
                  ...
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.address" name="address"
                    :label="t('views.warehouse.fields.address')">
                    <FormTextarea id="address" v-bind="field" name="address" type="text" :class="{ 'border-danger': errors['address'] }"
                ...
                <div class="pb-4">
                  ...
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.city" name="city"
                    :label="t('views.warehouse.fields.city')">
                    <FormInput id="city" v-bind="field" name="city" type="text" :class="{ 'border-danger': errors['city'] }"
                ...
                <div class="pb-4">
                  ...
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.contact" name="contact"
                    :label="t('views.warehouse.fields.contact')">
                    <FormInput id="contact" v-bind="field" name="contact" type="text" :class="{ 'border-danger': errors['contact'] }"
                ...
                <div class="pb-4">
                  ...
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.remarks" name="remarks"
                    :label="t('views.warehouse.fields.remarks')">
                    <FormTextarea id="remarks" v-bind="field" name="remarks" type="text" :class="{ 'border-danger': errors['remarks'] }"
                ...
                <div class="pb-4">
                  ...
                  <VeeField v-slot="{ field }" v-model="warehouseForm.data.status" name="status" rules="required" :label="t('views.warehouse.fields.status')">
